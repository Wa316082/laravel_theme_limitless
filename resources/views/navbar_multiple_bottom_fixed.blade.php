    ...
    <div class="page-content">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-inner">
                ...
                @slot('title') Multiple Navbars @endslot
                @slot('subtitle') Bottom Fixed @endslot
                @endcomponent
                ...
                <div class="content">
                    ...
                    <div class="alert alert-success alert-dismissible">
                        <div class="alert-heading fw-semibold">Multiple bottom fixed navbars</div>
                        Same logic here - just add 2 or move navbars before <code>.content-wrapper</code> closing tag and all those navbars will be sticked to the bottom of the screen and always will be displayed within the viewport.
