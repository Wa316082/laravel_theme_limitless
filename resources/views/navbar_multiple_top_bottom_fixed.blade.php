            ...
            <div class="content-inner">
                    ...
                    <div class="page-header-content d-lg-flex">
                        <div class="d-flex">
                            <h4 class="page-title mb-0">
                                Multiple Navbars - <span class="fw-normal">Top and Bottom</span>
                            </h4>
                    ...
                    <div class="page-header-content d-lg-flex border-top">
                        <div class="d-flex">
                            <div class="breadcrumb py-2">
                                ...
                                <a href="#" class="breadcrumb-item">Multiple navbars</a>
                                <span class="breadcrumb-item active">Top and bottom</span>
                            </div>
                ...
                <div class="content">
                    ...
                    <div class="alert alert-success alert-dismissible">
                        <div class="alert-heading fw-semibold">Fixed navbars in different locations</div>
                        New layout structure allows you to have as many static or fixed navbars as you want without any extra CSS or JS code. This example demonstrates 2 top and 1 bottom navbars that are placed outside all scrollable sections. It's a rare case scenario, but might be useful for very complex app layouts.
