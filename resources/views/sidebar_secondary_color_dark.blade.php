...
<body>
    ...
    <div class="page-content">
        ...
        <!-- Secondary sidebar -->
        <div class="sidebar sidebar-secondary sidebar-dark sidebar-expand-lg border-start border-start-white border-opacity-15">
            ...
            <div class="sidebar-content">
                ...
                <div class="sidebar-section sidebar-section-body d-flex align-items-center pb-2">
                    ...
                    <div class="ms-auto">
                        <button type="button" class="btn btn-flat-white border-transparent btn-icon rounded-pill btn-sm sidebar-control sidebar-secondary-toggle d-none d-lg-inline-flex">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-inner">
                ...
                @slot('subtitle') Secondary Dark @endslot
                @endcomponent
