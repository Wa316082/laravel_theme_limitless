    ...
    <div class="page-content">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-inner">
                ...
                @slot('subtitle') Sticky Footer @endslot
                @endcomponent
                ...
                <div class="content">
                    ...
                    <div class="alert alert-success alert-dismissible">
                        <div class="alert-heading fw-semibold">Sticky sidebar footer</div>
                        Sidebar footer can be sticked to the bottom of the sidebar content so that it always stays visible regardless scroll position. To achieve that, just move container outside <code>.sidebar-content</code> container. Sidebar on the left demonstrates this option.
