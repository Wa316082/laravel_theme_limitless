    ...
    <div class="page-content">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-inner">
                ...
                @slot('subtitle') Left Sectioned @endslot
                @endcomponent
                    ...
                    <div class="d-lg-flex">
                        ...
                        <div class="flex-1">
                            ...
                            <div class="alert alert-success alert-dismissible">
                                <div class="alert-heading fw-semibold">Sectioned sidebar</div>
                                Use <code>.card</code> instead of <code>.sidebar-section</code> in <code>.sidebar-component</code> container, along with a few additional utility classes in main sidebar container to display sidebar in cards format.
