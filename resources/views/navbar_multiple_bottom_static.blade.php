    ...
    <div class="page-content">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-inner">
                ...
                @slot('subtitle') Bottom Static @endslot
                @endcomponent
                ...
                <div class="content">
                    ...
                    <div class="alert alert-success alert-dismissible">
                        <div class="alert-heading fw-semibold">Multiple bottom static navbars</div>
                        You can also make navbars scrollable along with the content just by placing them before <code>.content-inner</code> closing tag. As simple as that.
