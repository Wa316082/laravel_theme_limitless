            ...
            <div class="content-inner">
                ...
                <div class="content">
                    ...
                    <div class="alert alert-success alert-dismissible">
                        ...
                        Bottom <code>fixed</code> navbar is positioned relatively to the screen's viewport and doesn't move when scrolled. To make bottom navbar fixed, move it outside <code>.content-inner</code> container. It's not a part of scrollable area, which means scrollbar will not overlap it.
