    ...
    <div class="page-content">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-inner">
                ...
                @slot('subtitle') Right Hideable @endslot
                @endcomponent
                ...
                <div class="content">
                    ...
                    <div class="alert alert-success alert-dismissible">
                        ...
                        This example demonstrates <code>hideable</code> state. Sidebar toggler is moved outside the sidebar and added to the top navbar. You can have this button anywhere - content, card or navbar. The only condition here is proper class names.
