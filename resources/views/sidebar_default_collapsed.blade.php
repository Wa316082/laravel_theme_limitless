    ...
    <div class="page-content">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-inner">
                ...
                @slot('subtitle') Default Collapsed @endslot
                @endcomponent
                ...
                <div class="content">
                    ...
                    <div class="alert alert-success alert-dismissible">
                        <div class="alert-heading fw-semibold">Collapsed default sidebar</div>
                        The following example demonstrates <code>collapsed</code> state. All sidebar content except full height button is hidden on desktop by default, on mobile all sidebar states look and work the same. Click the toggler to expand.
