    ...
    <div class="page-content">
        ...
        <div class="sidebar sidebar-secondary sidebar-expand-lg">
            ...
            <div class="d-flex border-top py-2 px-3">
                <a href="#" class="btn btn-light btn-icon flex-fill rounded-pill">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-inner">
                ...
                @slot('subtitle') Sticky Header &amp; Footer @endslot
                @endcomponent
                ...
                <div class="content">
                    ...
                    <div class="alert alert-success alert-dismissible">
                        <div class="alert-heading fw-semibold">Sticky sidebar header/footer</div>
                        Both sidebar header and footer can be sticked to the top and bottom of the sidebar content so that they always stay visible regardless scroll position. To achieve that, just move containers outside <code>.sidebar-content</code> container. Sidebar on the left demonstrates this option.
