    ...
    <div class="page-content">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-inner">
                ...
                @slot('subtitle') Right Collapsed @endslot
                @endcomponent
                ...
                <div class="content">
                    ...
                    <div class="alert alert-success alert-dismissible">
                        <div class="alert-heading fw-semibold">Collapsed right sidebar</div>
                        Right sidebar has 4 states - default, resized, collapsed and hidden. Collapsed and hidden states are sharing the same CSS, the only difference is sidebar toggle button. This example demonstrates <code>collapsed</code> state. Click the toggler to expand.
