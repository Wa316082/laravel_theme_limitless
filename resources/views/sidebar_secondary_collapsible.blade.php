    ...
    <div class="page-content">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-inner">
                ...
                @slot('subtitle') Secondary Collapsible @endslot
                @endcomponent
				...
				<div class="content">
					...
					<div class="alert alert-success alert-dismissible">
						<div class="alert-heading fw-semibold">Collapsible secondary sidebar</div>
						Secondary sidebar has 3 states - default, collapsed and hidden. Collapsed and hidden states are sharing the same CSS, the only difference is sidebar toggle button. This example demonstrates <code>default</code> state.
