    ...
    <div class="page-content">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-inner">
                ...
                @slot('subtitle') Secondary Hideable @endslot
                @endcomponent
                ...
                <div class="content">
                    ...
                    <div class="alert alert-success alert-dismissible">
                        ...
                        This example demonstrates <code>hideable</code> state. Sidebar toggler is moved outside the sidebar and added to page header. You can have this button anywhere - content, card or navbar. The conly condition here is proper class names.
