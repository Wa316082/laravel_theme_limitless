    ...
    <div class="page-content">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-inner">
                ...
                @slot('subtitle') Sticky Containers @endslot
                @endcomponent
                ...
                <div class="content">
                    ...
                    <div class="alert alert-success alert-dismissible">
                        <div class="alert-heading fw-semibold">Custom sticky sidebar containers</div>
                        Custom containers can be easily sticked to the top or bottom of the sidebar just by moving them outside <code>.sidebar-content</code> container and placed either before or after it. Example on the left shows sticked header and search field.
