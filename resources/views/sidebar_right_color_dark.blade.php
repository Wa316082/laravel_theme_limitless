    ...
    <div class="page-content">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-inner">
                ...
                @slot('subtitle') Right Dark @endslot
                @endcomponent
        ...
        <div class="sidebar sidebar-dark sidebar-end sidebar-expand-lg">
            ...
            <!-- Expand button -->
            <button type="button" class="btn btn-sidebar-expand sidebar-control sidebar-end-toggle">
            ...
            <div class="sidebar-content">
                ...
                <div class="sidebar-section sidebar-section-body d-flex align-items-center pb-2">
                    ...
                    <div class="ms-auto">
                        <button type="button" class="btn btn-flat-white border-transparent btn-icon rounded-pill btn-sm sidebar-control sidebar-end-toggle d-none d-lg-inline-flex">
                            <i class="ph-arrows-left-right"></i>
                        </button>
