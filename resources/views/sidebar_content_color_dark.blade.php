            ...
            <div class="content-inner">
                ...
                <div class="content">
                    ...
                    <div class="d-lg-flex align-items-lg-start">
                        ...
                        <div class="sidebar sidebar-component sidebar-dark sidebar-expand-lg border rounded shadow-sm me-lg-3 mb-3">
                            ...
                            <div class="sidebar-content">
                                ...
                                <div class="sidebar-section sidebar-section-body d-flex align-items-center d-lg-none pb-2">
                                    ...
                                    <div class="ms-auto">
                                        <button type="button" class="btn btn-flat-white border-transparent btn-icon rounded-pill btn-sm sidebar-mobile-component-toggle">
                                            <i class="ph-x"></i>
                                        </button>
                                    </div>
                                </div>
